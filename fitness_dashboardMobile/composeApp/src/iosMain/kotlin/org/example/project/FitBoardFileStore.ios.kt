...
private fun parseDailyRecord(json: Map<*, *>, fallbackDate: String): StoredDailyRecord {
    ...
    return StoredDailyRecord(
        ...
        healthSummary = StoredHealthSummary(
            ...
            todayWeightKilograms = healthJson?.doubleValue("todayWeightKilograms", 0.0) ?: 0.0,
            hasTodayWeight = healthJson?.boolValue("hasTodayWeight", false) ?: false,
            weightHistoryRaw = healthJson?.stringValue("weightHistoryRaw", "") ?: "",
...
private fun StoredDailyRecord.toJsonObject(): Map<String, Any?> {
    return mapOf(
        ...
        "healthSummary" to mapOf(
            ...
            "todayWeightKilograms" to healthSummary.todayWeightKilograms,
            "hasTodayWeight" to healthSummary.hasTodayWeight,
            "weightHistoryRaw" to healthSummary.weightHistoryRaw,
